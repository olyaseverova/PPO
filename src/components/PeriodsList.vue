    ...
    return {
      periods: [
        ...
        },
        {
          label: "Название",
          type: "text",
          placeholder: "Утренние молитвы 7:00 - 11:00",
          status: true,
          status_clock: false,
          input: "input2",
          id: "period2",
        ...
        {
          label: "Просветительские беседы (общ. Свят. Николая)",
          type: "time",
          value1: "10:30",
          value2: "11:30",
          status: false,
        ...
        {
          label: "Просветительские беседы (общ. вмц. Варвары)",
          type: "time",
          value1: "12:00",
          value2: "13:00",
          status: false,
        ...
        {
          label: "Просветительские беседы (о. Алипий)",
          type: "time",
          value1: "16:30",
          value2: "17:00",
          status: false,
